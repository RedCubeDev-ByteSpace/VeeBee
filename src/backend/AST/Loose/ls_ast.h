...
typedef enum LOOSE_NODE_TYPE {
    ...
    // Statements
    LS_EMPTY_STATEMENT         = 0x010 | 0b0000'0010,
    LS_DIM_STATEMENT           = 0x020 | 0b0000'0010,
    LS_REDIM_STATEMENT         = 0x030 | 0b0000'0010,
    LS_LET_STATEMENT           = 0x040 | 0b0000'0010,
    LS_SET_STATEMENT           = 0x050 | 0b0000'0010,
    LS_IF_STATEMENT            = 0x060 | 0b0000'0010,
    LS_SELECT_STATEMENT        = 0x070 | 0b0000'0010,
    LS_FOR_STATEMENT           = 0x080 | 0b0000'0010,
    LS_FOR_EACH_STATEMENT      = 0x090 | 0b0000'0010,
    LS_DO_STATEMENT            = 0x0A0 | 0b0000'0010,
    LS_WHILE_STATEMENT         = 0x0B0 | 0b0000'0010,
    LS_GOTO_STATEMENT          = 0x0C0 | 0b0000'0010,
    LS_LABEL_STATEMENT         = 0x0D0 | 0b0000'0010,
    LS_ON_ERROR_STATEMENT      = 0x0E0 | 0b0000'0010,
    LS_RESUME_STATEMENT        = 0x0F0 | 0b0000'0010,
    LS_WITH_STATEMENT          = 0x100 | 0b0000'0010,
    LS_CALL_STATEMENT          = 0x110 | 0b0000'0010,
    LS_EXIT_SUB_STATEMENT      = 0x120 | 0b0000'0010,
    LS_EXIT_FUNCTION_STATEMENT = 0x130 | 0b0000'0010,
    LS_EXIT_PROPERTY_STATEMENT = 0x140 | 0b0000'0010,

    // Expressions
    LS_UNARY_EXPRESSION         = 0x10 | 0b0000'0100,
    LS_BINARY_EXPRESSION        = 0x20 | 0b0000'0100,
    LS_CALL_EXPRESSION          = 0x30 | 0b0000'0100,
